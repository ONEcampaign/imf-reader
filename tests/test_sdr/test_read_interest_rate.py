...
class TestReadInterestRate:
    ...
    @patch("imf_reader.sdr.read_interest_rate.make_post_request")
    ...
    def test_get_interest_rates_data_connection_error(self):
        ...
        with patch("imf_reader.sdr.read_interest_rate.make_post_request") as mock_post:
    ...
    def test_get_interest_rates_data_parse_error(self):
        ...
        with (
            patch("imf_reader.sdr.read_interest_rate.make_post_request") as mock_post,
